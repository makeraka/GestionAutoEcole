            ...
            <div class="col-lg-10">
                <div class="card">  <!--card start-->
                    ...
                    <div class="card-header">
                        <h5 class="card-title">Ajouter un Payement</h5>
                    </div>

                    <div class="card-body"><!--card body-->
                        <form role="form" action="{{route('InsertPayement')}} " method="POST">
                            @csrf
                            <div class="form-group-row">
                                <label for="categorie" class="col-sm-2 col-form-label">Categorie </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="categorie" placeholder="Entrer la catégorie " required>
                                </div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="montantpaye" placeholder="Entrer le montant payé" required>
                                </div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="montantrestant" placeholder="Entrer montant restant" required>
                                </div>

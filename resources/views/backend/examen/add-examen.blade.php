            ...
            <div class="col-lg-10">
                <div class="card">  <!--card start-->
                    ...
                    <div class="card-body"><!--card body-->
                        <form role="form" action="{{route('InsertExamen')}} " method="POST">
                            @csrf
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="date" placeholder="Entrer date Examen" required>
                                </div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <select name="typeExamen" class="form-control" id="Example">
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <select name="resultat" class="form-control" id="Example">
                                        <option value="">Type</option>

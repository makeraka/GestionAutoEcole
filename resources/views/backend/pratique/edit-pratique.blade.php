            ...
            <div class="col-lg-10">
                <div class="card">  <!--card start-->
                    ...
                    <div class="card-body"><!--card body-->
                        <form role="form" action="{{route('UpdatePratique')}} " method="POST">
                            @csrf

                            <div class="form-group-row">
                                <label for="dateCour" class="col-sm-2 col-form-label">Id</label>
                                <div class="col-sm-10">
                                    <input type="id" class="form-control" name="id" value="{{$pratiques->id}}">
                                </div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-sm-10">
                                    <select name="seance" class="form-control" id="Example">
